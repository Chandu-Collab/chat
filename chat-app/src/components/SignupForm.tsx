  ...
  return (
    ...
    >
      <div className="mb-6 w-full text-center">
        <span className="block text-3xl font-bold text-white mb-1 tracking-tight">Sign Up</span>
        <span className="block text-base text-gray-300">Create your account to get started</span>
      </div>
      <div className="space-y-5 w-full flex flex-col items-center">
        ...
        <div className="relative w-full flex items-center">
          <input
            ...
            className={`w-full text-center bg-white/20 border border-gray-500/30 text-white placeholder-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 ${passwordValid ? 'focus:ring-purple-400' : 'border-red-500 focus:ring-red-400'} transition-all duration-200 shadow-inner`}
            required
          />
          <button
            type="button"
